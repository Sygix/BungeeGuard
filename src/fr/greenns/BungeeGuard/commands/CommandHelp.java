...
public class CommandHelp extends Command {
	...
	public void execute(CommandSender sender, String[] args) {
			...
			sender.sendMessage(new ComponentBuilder("---------------[ ").color(ChatColor.GOLD).append("✔ COMMANDES ✔ ").color(ChatColor.GREEN).color(ChatColor.BOLD).append("]-----------------").color(ChatColor.GOLD).create());
