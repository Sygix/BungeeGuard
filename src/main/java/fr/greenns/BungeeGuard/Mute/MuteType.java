...
public enum MuteType {
    ...
    NON_PERMANENT_W_REASON(ChatColor.RED + "Vous avez été mute pendant " + ChatColor.AQUA + "+timeStr" + ChatColor.RED + " pour: " + "+reasonStr", ChatColor.AQUA + "+adminName" + ChatColor.RED + " a mute " + ChatColor.GREEN + "+muteName" + ChatColor.RED + " pendant " + ChatColor.AQUA + "+timeStr" + ChatColor.RED + " pour: " + ChatColor.AQUA + "+reasonStr"),
