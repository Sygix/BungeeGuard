        ...
        if (args.length == 1) {
            ...
            plugin.executePersistenceRunnable(new VoidRunner() {
                ...
                protected void run() {
                    ...
                    Integer presence = Integer.valueOf(String.valueOf(Base.firstCell("SELECT SUM(leaved_at - joined_at) FROM bungeelitycs WHERE uuid = ? AND leaved_at IS NOT NULL", "" + u)));
